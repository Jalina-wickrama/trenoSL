...
<?php
    ...
    if(isset($_POST['emp_login']))
    {
      ...
      if($rs)
      {//if its sucessfull
        header("location:emp-welcome.php");
      }
...
<head>
    ...
    <link rel="shortcut icon" href="assets/img/Trenosllogo.png">
    <title>Treno SL Online Reservation System</title>
        ...
        <div class="main-content container-fluid">
          <div class="splash-container">
            <div class="card card-border-color card-border-color-danger">
              <div class="card-header"><img class="logo-img" src="assets/img/Trenosllogo.png" alt="logo" width="{conf.logoWidth}" height="27"><span class="splash-description">Please enter your user information.</span></div>
              <div class="card-body">
                ...
                <form method ="POST">
                  <div class="login-form ">
                    ...
                    <div class="form-group row login-submit">
                      <div class="col-6"><input type = "submit" name ="emp_login" class="btn btn-danger btn-xl" value ="Log In"></div>
                    </div>
            ...
            <div class="splash-footer">&copy; 2019 - <?php echo date ('Y');?> Treno SL Online Reservation System | Powered By <a href = "https://esoft.lk/" target ="_blank" >Esoft Students</a></div>
          </div>
        </div>
      </div>
    </div>
