                  ...
                  <form method ="POST" enctype="multipart/form-data">
                    <div class="form-group row">
                      ...
                      <div class="col-12 col-sm-8 col-lg-6">
                        <input class="btn btn-outline-danger" name="admin_dpic"  id="inputText3" type="file">
                      </div>
                    </div>
                   
                    <div class="col-sm-6">
                        <p class="text-right">
                          <input class="btn btn-space btn-danger" value ="Update Profile" name = "Update_profile_pic" type="submit">
