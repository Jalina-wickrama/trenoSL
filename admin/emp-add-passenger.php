	...
	include('assets/inc/config.php');
      ...
      //sql to insert captured values
			...
			*/ 
			...
			if($stmt)
			{
				$success = "Passenger Created Account";
			}
			else {
                ...
                <div class="card-body">
                  <form method ="POST">
                    ...
                    <div class="form-group row">
                      ...
                      <div class="col-12 col-sm-8 col-lg-6">
                        <input class="form-control" name="pass_phone"  id="inputText3" type="text">
                      </div>
                    </div>
                    <div class="form-group row">
                    ...
                    <div class="col-sm-6">
                        <p class="text-right">
                          <input class="btn btn-space btn-danger" value ="Create Passenger " name = "Create_Profile" type="submit">
