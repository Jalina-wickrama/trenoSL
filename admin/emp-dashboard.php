    ...
    <!--Navbar-->
     <?php include("assets/inc/navbar.php");?>
      ...
      <div class="be-content">
        ...
        <div class="row">
            <div class="col-12 col-lg-6 col-xl-3" style="color: black;"> 
              <div class="widget widget-tile row1 ">
              <div class="chart sparkline"><i class="material-icons">airline_seat_recline_normal</i></div>
                ...
                ?>
                  ...
                  <div class="value"><span class="number" data-toggle="counter" data-end="<?php echo $pass;?>">0</span>
                  </div>
                </div>
              </div>
            </div>
            <div class="col-12 col-lg-6 col-xl-3">
              <div class="widget widget-tile row2">
            ...
            <div class="col-12 col-lg-6 col-xl-3">
              <div class="widget widget-tile row3">
              <div class="chart sparkline"><i class="material-icons">directions_subway</i></div>
                ...
                ?>
                  ...
                  <div class="value"><span class="number" data-toggle="counter" data-end="<?php echo $train;?>">0</span>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div class="col-12 col-lg-6 col-xl-3">
              <div class="widget widget-tile row4">
            ...
            <div class="col-12 col-lg-6 col-xl-3">
              ...
              <div class="chart sparkline"><i class="material-icons">local_activity</i></div>
                ...
                <?php
                  ...
                  $stmt->close();
                ?>
                  <div class="desc">Password Resets</div>
                  <div class="value"><span class="number" data-toggle="counter" data-end="<?php echo $pass;?>">0</span>
                  </div>
                </div>
              </div>
            ...
            <div class="chart sparkline"><i class="material-icons">rowing</i></div>
              ...
              <?php
                ...
                <div class="value"><span class="number" data-toggle="counter" data-end="<?php echo $resevations;?>">0</span>
                </div>
              </div>
            </div>
            </div>
