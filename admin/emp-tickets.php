              ...
              <div class="card card-table">
                ...
                <div class="card-body">
                  <table class="table table-striped table-hover table-fw-widget" id="table1">
                    <thead>
                      <tr>
                        <th class="table-danger">Passeger Name</th>
                    ...
                    ?>
                      <tr class="odd gradeX even gradeC odd gradeA even gradeA ">
                        <td class="table-danger"><?php echo $row->pass_name;?></td>
                        ...
                        <td class="center"><span class="badge badge-pill badge-danger">LKR</span><?php echo $row->train_fare;?></td>
