        ...
        <div class="main-content container-fluid">
          <div class="splash-container">
            <div class="card card-border-color card-border-color-danger">
              <div class="card-header"><img class="logo-img" src="assets/img/Trenosllogo.png" alt="logo" width="{conf.logoWidth}" height="35"><span class="splash-description">Please enter your user information.</span></div>
              <div class="card-body">
                ...
                <form method ="POST">
                  <div class="signup-form">
                    ...
                    <div class="form-group row login-submit">
                      ...
                      <div class="col-6"><input type = "submit" name ="pass_register" class="btn btn-danger btn-xl" value ="Register"></div>
                    </div>
            ...
            <div class="splash-footer">&copy; 2019 - 2023 <?php echo date ('Y');?> Treno SL Online Reservation System | Powered By <a href = "https://esoft.lk/" target ="_blank" >Esoft Students</a></div>
