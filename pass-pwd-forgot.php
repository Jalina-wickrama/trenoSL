        ...
        <div class="main-content container-fluid">
          <div class="splash-container forgot-password">
            <div class="card card-border-color card-border-color-danger">
              <div class="card-header"><img class="logo-img" src="assets/img/Trenosllogo.png" alt="logo" width="102" height="#{conf.logoHeight}"><span class="splash-description">Forgot your password?</span></div>
              <div class="card-body">
            ...
            <?php } ?>
              <!--Password Reset Form-->
                <form method ="POST" >
                  ...
                  <div class="form-group pt-1"><input type ="submit" name ="Pwd_reset" class="btn btn-block btn-danger btn-xl" value = "Reset Password"></div>
                </form>
                <!--End Password Reset-->
              </div>
            </div>
