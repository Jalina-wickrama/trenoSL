            ...
            <!--Train Details-->
              <div id='printReceipt' class="invoice">
                <div class="row invoice-header">
                  <div class="col-sm-7">
                    <div class="invoice-log"></div>
                    <a href="emp-welcome.php"><img src="assets/img/Trenosllogo.png" height="65px" width="35%" style="padding-left: 10px; padding-right: 60px;"/></a>
                  </div>
                  ...
                  <div class="col-lg-12">
                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td><span class="badge badge-pill badge-danger">LKR</span><?php echo $row->pass_train_fare;?></td>
                      </tr>
                      <hr>
                        <?php }?>
                    </tbody>
              ...
              <div class="row invoice-footer">
                  <div class="col-lg-12">
                    <button id="print" onclick="printContent('printReceipt');" class="btn btn-lg btn-space btn-danger">Print</button>
                  </div>
                </div>
            </div>
          </div>
