        ...
        <div class="main-content container-fluid">
          <div class="splash-container">
            <div class="card card-border-color card-border-color-danger">
              <div class="card-header"><img class="logo-img" src="images/Trenosllogo.png" alt="logo" width="{conf.logoWidth}" height="35"><span class="splash-description">Please enter the user information.</span></div>
              <div class="card-body">
                ...
                <form method ="POST">
                  <div class="login-form ">
                    ...
                    <div class="form-group row login-submit">
                      ...
                      <div class="col-6"><input type = "submit" name ="pass_login" class="btn btn-danger btn-xl" value ="Log In"></div>
                    </div>
            ...
            <div class="splash-footer">&copy; 2019 - <?php echo date ('Y');?> TrenoSL Railway Reservation System | Powered By <a href = "https://esoft.lk/" target ="_blank" >Esoft Students</a></div>
          </div>
        </div>
      </div>
    </div>
