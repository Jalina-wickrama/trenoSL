              ...
              <div class="card card-border-color card-border-color-danger">
                ...
                <div class="card-body">
                  <form method ="POST">
                    ...
                    <div class="form-group row">
                      <label class="col-12 col-sm-3 col-form-label text-sm-right" for="inputText3">My Birthday</label>
                      <div class="col-12 col-sm-8 col-lg-6">
                        <input class="form-control" name="pass_bday" value="<?php echo $row->pass_bday;?>" id="inputText3" type="text">
                      </div>
                    </div>
                    <div class="form-group row">
                      <label class="col-12 col-sm-3 col-form-label text-sm-right" for="inputText3">My Bio</label>
                      <div class="col-12 col-sm-8 col-lg-6">
                    ...
                    <div class="col-sm-6">
                        <p class="text-right">
                          <input class="btn btn-space btn-danger" value ="Update Profile" name = "Update_Profile" type="submit">
